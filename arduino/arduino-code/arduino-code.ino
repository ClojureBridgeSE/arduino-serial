...
void loop()
{
   int value1 = ADCTouch.read(A3, 300);   //   --> 100 samples
   int value2 = ADCTouch.read(A2, 300);   //   --> 100 samples
   int value3 = ADCTouch.read(A1, 300);   //   --> 100 samples
   int value4 = ADCTouch.read(A0, 300);   //   --> 100 samples
   int value5 = ADCTouch.read(A4, 300);   //   --> 100 samples
   int value6 = ADCTouch.read(A5, 300);   //   --> 100 samples
